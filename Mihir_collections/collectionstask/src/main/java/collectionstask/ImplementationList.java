...
public class ImplementationList<Y> {
    int a_size = 0;
    private static final org.apache.logging.log4j.Logger amaresh1 =LogManager.getLogger(Accessingclass.class);
   ...
   public void adding (Y val) {
    ...
    public Y getting(int pos) {
 	   ...
 	   catch(Exception r)
 	   {
 		   ...
 		   amaresh1.info("Index was not present within the range: " + pos);
 		    }
   ...
   public Y remove(int pos) {
	   ...
	   {
		  //System.out.println("Index was not present within the range: " + pos);
		   amaresh1.error("Index was not present within the range: " + pos);
		    }
